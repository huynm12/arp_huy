...
_C.MODEL.PANOPTIC_DEEPLAB.INSTANCE.ORACLE_SEMANTIC = False
_C.MODEL.PANOPTIC_DEEPLAB.INSTANCE.SEMANTIC_EMBED_CHANNELS = 64
_C.MODEL.PANOPTIC_DEEPLAB.INSTANCE.USE_SEMANTIC = True
_C.MODEL.PANOPTIC_DEEPLAB.SEMANTIC = CN()
_C.MODEL.PANOPTIC_DEEPLAB.SEMANTIC.PRETRAINED = ''
_C.MODEL.PANOPTIC_DEEPLAB.SEMANTIC.IGNORE_HEAD = True
_C.MODEL.PANOPTIC_DEEPLAB.FREEZE_MODULE = 'instance'
# -----------------------------------------------------------------------------
# DATASET
# -----------------------------------------------------------------------------
_C.DATASET = CN()
...
_C.DATASET.TRAIN_FILE = 'train.txt'
_C.DATASET.TEST_FILE = 'val.txt'
_C.DATASET.CROP_SIZE = (513, 1025)
_C.DATASET.RESCALE_SIZE = (513, 1025)
