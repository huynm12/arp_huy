...
__all__ = ["InstanceDeepLabDecoder"]


class SingleInstanceDeepLabDecoder(nn.Module):
    def __init__(self, in_channels, feature_key, low_level_channels, low_level_key, low_level_channels_project,
        ...
        super(SingleInstanceDeepLabDecoder, self).__init__()
...
class SingleInstanceDeepLabHead(nn.Module):
    def __init__(self, decoder_channels, head_channels, num_classes, class_key):
        super(SingleInstanceDeepLabHead, self).__init__()
        fuse_conv = partial(stacked_conv, kernel_size=5, num_stack=1, padding=2,
                            conv_type='depthwise_separable_conv')
...
class InstanceDeepLabDecoder(nn.Module):
    def __init__(self, in_channels, feature_key, low_level_channels, low_level_key, atrous_rates, **kwargs):
        super(InstanceDeepLabDecoder, self).__init__()
        ...
        self.instance_decoder = SingleInstanceDeepLabDecoder(**instance_decoder_kwargs)
        ...
        self.instance_head = SingleInstanceDeepLabHead(**instance_head_kwargs)
